CREATE DATABASE  IF NOT EXISTS `idarraga_arino_karmel_dwes05` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `idarraga_arino_karmel_dwes05`;
